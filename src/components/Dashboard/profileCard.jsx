...
import { User, Edit2, Copy, Lock } from 'lucide-react'; // Lock 아이콘 추가
...
const ProfileCard = ({
  ...
  const handleCopyId = () => {
    if (!user) return; // 로그인 안했을 땐 복사 방지
      ...
      <div className="flex items-start gap-6">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="text-center min-w-max px-1">
            ...
            {/* ✅ 고유 ID 비활성화 처리 */}
            <div className={`mt-1 flex items-center justify-center gap-1.5 transition-all ${!user ? 'opacity-30 grayscale blur-[1px]' : ''}`}>
        ...
        <div className="flex-1 relative">
          ...
          <div className="relative w-full aspect-square flex items-center justify-center pt-4 overflow-hidden">
            ...
            <div className={!user ? 'opacity-20 grayscale transition-all' : 'transition-all'}>
